...
## reference: https://stagate.readthedocs.io/en/latest/Installation.html
...
for i in range(10):
    ...
    # import our packages
    from STAGATE_pyG.STAGATE_pyG.utils import Cal_Spatial_Net, Stats_Spatial_Net, mclust_R
    from STAGATE_pyG.STAGATE_pyG.Train_STAGATE import train_STAGATE
